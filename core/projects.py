...
project_1_description = "This 5.6MW project was completed ahead of schedule by a team of 5 electricians and mechanical contractors. A total of\
    ...
    understanding of 3 phase power systems, IT infrastructure, and love of building."
...
project_1 = {
    ...
    "detail_url": "project_little_rock",
...
project_2_description = "Developed C++ hardware libraries for document scanning and biometric authentication systems integrated into \
    QT6 QML applications for financial kiosks and ATM machines. Built a full-stack check cashing web application using FastAPI, \
    PostgreSQL, and Docker with JWT authentication, TOTP two-factor auth, and Azure Document Intelligence integration.\
    |Cloud infrastructure included AWS S3 for file storage, Twilio SMS verification, and containerized deployment with automated \
    database migrations."

project_2 = {
    "name": "Gigavend Money Services Financial Kiosk",
    "description": project_2_description,
    "index_image": "gigavend/gigavend_thumbnail.png",
    "detail_url": None,
}
